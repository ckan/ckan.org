    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contributors_image', models.ForeignKey(help_text="Contributors' photos", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='blog.customimage')),
            ],
            options={
                'abstract': False,
            },

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_as_button', models.BooleanField(default=False, null=True)),
                ('svg_icon', models.TextField(blank=True, max_length='2048', null=True)),
                ('icon_before_text', models.BooleanField(default=False, null=True)),
